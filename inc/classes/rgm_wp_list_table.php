<?php 
if ( ! class_exists( 'RGM_WP_List_Table' ) ) {
	 ...
	 */
	class RGM_WP_List_Table extends WP_List_Table {
		...
		<div class="flippercode-ui">
			<div class="rgm-main">
				<div class="rgm-container">
					<div class="rgm-divider">
                    <div class="rgm-back">
						<div class="rgm-12">
							
						<div class="rgm-overview">
	<?php $this->show_notification( $this->response ); ?>
							...
							<?php wp_nonce_field( 'rgm-nonce','_wpnonce',true,true ); ?>
						</form>
						</fieldset>
							</div>
							</br>
...
<?php	}
		...
		public function show_message($message, $errormsg = false) {
			...
			} else { 		echo "<div class='notice notice-success is-dismissible'><p>{$message}</p></div>"; }
